...
import com.google.mediapipe.examples.llminference.ui.theme.ApiConfig.promptTemplate
...
class ContextFusionAnalyzer(
    ...
    fun generatePrompt(maxLength: Int = 2048): String {
        ...
        val truncatedMotion = motionHistory.takeLast(maxLength)
        val truncatedLocation = locationHistory.takeLast(maxLength)
...
//
//                val prompt = ApiConfig.promptTemplate+"""
//                \n
//                Motion: $truncatedMotion
//                Location: $truncatedLocation
//                Provide your response in the exact JSON format specified above.
